      ...
      <div class="col-9">
        ...
        <el-tooltip placement="right" effect="light" style="display: inline; margin-left: 20px" id="button-note">
          <el-button type="primary" class="el-icon-info el-button--info el-calendar__header"
                     style="border-radius: 10px"> Chú thích
          </el-button>
    ...
    >
      ...
      <table v-if="showAdminBoard" class="table table-bordered align-middle">
        ...
        <tr :class="{
          ...
          <td
              v-for="(log, index) in u.furloughs" :key="index">{{ log.usedInMonth }}
          </td>
