...
<span>
  <div v-for="(note,index) in noteSort" :key="index">
    ...
    <div v-if="note.noteCatergory.note_catergory_id==1">
      ...
      <div class="avatar">
        <b-avatar class="me-3" size="30px" v-bind:src="`http://localhost:8100/` + note.adminEdit.cover"></b-avatar>
    ...
    <div v-if="note.noteCatergory.note_catergory_id==3">
      ...
      <div class="avatar">
        <b-avatar class="me-3" size="30px"
                  v-bind:src="`http://localhost:8100/` + note.approversRequest.cover"></b-avatar>
