    ...
    <div class="container register" style="border-radius: 10px">
      <div class="row">
        <div class="col-md-3 register-left">
          ...
          <img
              style="width: 250px; line-height: 100%"
              src="../../../public/blue_ICON-removebg.png"
          />
        </div>
                        ...
                        <td style="width: 300px">
                          <div class="form-group">
                            <el-input
                                ...
                                autocomplete="off"
                            >
                              <template slot="prepend">BLUE_</template>
                            </el-input>
                          </div>
...
export default {
  ...
  mounted() {
    UserService.getUserById(this.$route.params.id).then((response) => {
      ...
      this.user.code = String(this.user.code.split("_")[1]);

      console.log(this.user);
      this.newImage =
          this.user.cover !== null
              ? "http://localhost:8100/" + this.user.cover
